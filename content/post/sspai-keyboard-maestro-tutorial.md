...
![Keyboard Maestro 2.0 的界面](https://p15.p3.n0.cdn.getcloudapp.com/items/WnupBxd9/c03a0b11-6744-4b61-badd-34603ab20a42.png)

![Keyboard Maestro 10.2 的界面](https://p15.p3.n0.cdn.getcloudapp.com/items/llu89NzY/e66c1f56-64d9-429f-8d12-8fa7634bfb12.png)
...
![通过点击齿轮图标查看 action 的更多设置](https://p15.p3.n0.cdn.getcloudapp.com/items/04udJ2rJ/487f595f-5ae4-4d68-88da-21e12657fca5.png)
...
![通过快捷键激活 Safari](https://p15.p3.n0.cdn.getcloudapp.com/items/kpuR7D7n/3f9e7f31-9b29-4442-aefe-23345ce68fe5.png)
...
![在 Mac 停止休眠后重启 Lunar](https://p15.p3.n0.cdn.getcloudapp.com/items/o0uKEeEL/1b6fb884-8e80-43e2-90e9-55e87013e9e6.png)
...
![使用 Keyboard Maestro 计算剪贴板中的字数](https://p15.p3.n0.cdn.getcloudapp.com/items/YEuzXZX5/7572371e-c7d3-4975-8846-9c69e068b5d2.png)
...
![执行 Shell 脚本将剪贴板中的大写字母转换为小写字母，并保存到剪贴板中](https://p15.p3.n0.cdn.getcloudapp.com/items/6quwQr8O/d347b577-5d02-4781-b35b-f12a68d37411.png)
...
![默认情况下 Capture to Drafts 没有一个全局快捷键](https://p15.p3.n0.cdn.getcloudapp.com/items/jku6ePLq/f2e77272-30e5-423f-9c32-af505968f447.png)

在这方面，Keyboard Maestro 通过与操作系统的深度整合，既利用了系统原有的功能，又进一步优化，使得系统中原本「还能用」的功能变得更加实用和全面。

![用 Keyboard Maestro 为 Safari 小书签分配一个快捷键，将繁体中文转换为简体中文](https://p15.p3.n0.cdn.getcloudapp.com/items/yAun6rDY/022403bd-df4d-44a2-9ab9-b746589a2c30.gif)
...
![Keyboard Maestro 网站主页](https://p15.p3.n0.cdn.getcloudapp.com/items/ApulRzNv/c10f8816-618b-4859-b149-637deb354749.png)
...
![试用快结束时 Keyboard Maestro 的购买提示](https://p15.p3.n0.cdn.getcloudapp.com/items/2NuWEq2n/b216bf1d-5afa-48c6-9043-4c6e2d088f04.png)
...
![Keyboard Maestro 已为我节省了 5 天时间，不过由于我重新安装过它，实际节省的时间远不止于此](https://p15.p3.n0.cdn.getcloudapp.com/items/YEuzXZvj/f83510c5-0f54-4818-91d7-4a25a3f5b1ed.png)
...
![从 macOS App icons 网站上下载的圆角 Keyboard Maestro 图标](https://p15.p3.n0.cdn.getcloudapp.com/items/7KuXpox2/d78eaab7-85b0-480a-8885-d003775378aa.png)
...
![在系统设置中为 Keyboard Maestro 打开「辅助功能」选项](https://p15.p3.n0.cdn.getcloudapp.com/items/NQu5JoeZ/f2c3f9c4-306c-4e50-903d-fbf42e7dcdcd.png)
...
![在系统设置中为 Keyboard Maestro 打开「屏幕录制」选项](https://p15.p3.n0.cdn.getcloudapp.com/items/mXuv1r7P/9f2bd557-571e-45f7-a3e4-3518029e9e1a.png)
...
![为 Keyboard Maestro 授予 System Events 权限的提示窗口](https://p15.p3.n0.cdn.getcloudapp.com/items/OAu7gQx7/81d170d8-ce37-453f-a0f9-6dd222667842.png)

如果你不确定 Keyboard Maestro 能够控制哪些应用，或者需要对其进行修改，可以前往「系统设置 -\> 隐私与安全性 -\> 自动化」中找到 Keyboard Maestro 下方的应用程序，如下图所示。

![Keyboard Maestro 控制的「自动操作」应用列表](https://p15.p3.n0.cdn.getcloudapp.com/items/o0uKEexz/3544525b-1dd4-4f2c-8262-a1b41e15ba69.png)

### 创建 macro

在安装好 Keyboard Maestro 之后，首次启动时会显示一个新手导览页面，如下图所示。

![Keyboard Maestro 新手导览](https://p15.p3.n0.cdn.getcloudapp.com/items/ApulRzy4/74bd6972-41b0-416d-842d-9b2e9b370de1.png)
...
![按下快捷键 `F6` 打开 `~/Documents`](https://p15.p3.n0.cdn.getcloudapp.com/items/YEuzXZAX/007b4feb-ef92-4d31-aea1-510880ee12c0.gif)

### 软件基本设置

打开 Keyboard Maestro，点击菜单栏中的「Settings…」，或者按下快捷键 `⌘ + ,`，就会打开软件的设置界面。

![点击菜单栏图标打开 Keyboard Maestro 设置界面](https://p15.p3.n0.cdn.getcloudapp.com/items/7KuXpoRA/e8f45440-2f05-462a-ba74-bf8c8a6101af.png)

![Keyboard Maestro 的设置界面](https://p15.p3.n0.cdn.getcloudapp.com/items/qGuYX5o6/f74e21c4-5e9a-4bd4-8587-15f06a3613ab.png)
...
![点击菜单栏选项打开日志文件夹](https://p15.p3.n0.cdn.getcloudapp.com/items/mXuv1rq4/f1a23bd8-4167-4c1a-befd-693fbe4de394.png)
...
![点击菜单栏选项打开新手导览](https://p15.p3.n0.cdn.getcloudapp.com/items/v1unNYr7/12ac2be7-5435-4896-ba55-afddcb354ef6.png)
...
![在 Keyboard Maestro 中导出 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/GGuy6Wkn/494be956-a4f1-416a-9e31-9649b5435a13.png)
...
![用 VS Code 打开从 Keyboard Maestro 中导出的 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/bLuygker/073376c3-7e94-4b10-85f3-985a8e288ee5.png)
...
![通过点击菜单栏图标导入 macros](https://p15.p3.n0.cdn.getcloudapp.com/items/WnupBxGl/8966184c-1e58-41cd-9ffd-f008e8f07b97.png)
...
![选择创建或打开已有的同步文件](https://p15.p3.n0.cdn.getcloudapp.com/items/5zubAY1o/d564e276-4401-47bc-950b-534d43b5ae0c.png)
...
![在访达中对文件批量重命名](https://p15.p3.n0.cdn.getcloudapp.com/items/P8uDk9EP/fb8c945b-4622-41f8-8d4e-360e62a1e628.png)
...
![导入「Rename Finder Files」](https://p15.p3.n0.cdn.getcloudapp.com/items/04udJ2P7/238b0aaf-9697-4cd3-8214-68322b94b4d6.png)

可以看到，上图中这个 macro 的功能是「在访达中使用正则表达式批量重命名文件」。导入之后可以看到，这个 macro 的默认 trigger 是点击菜单栏图标，当然你也可以设置为其他 trigger，展开所有 action 的截图如下。

![Keyboard Maestro 自带的用于对文件批量重命名的 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/9ZuL8djv/016e18d7-203a-4c96-9fd1-c0f66dfcfab6.png)
...
![通过 Keyboard Maestro 自带的 macro 批量重命名文件](https://p15.p3.n0.cdn.getcloudapp.com/items/o0uKEevB/dbc17475-30b9-4bdb-99e5-54d9f9edbbdc.gif)
...
![使用命令行工具 rename 对文件批量重命名的 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/Jrum1DLg/7eee9fdd-b0d5-4aac-b967-fed0718cdec8.png)
...
![使用命令行工具 rename 对文件批量重命名](https://p15.p3.n0.cdn.getcloudapp.com/items/yAun6rYD/01303a37-e59a-4ea7-a275-4a61a413861b.gif)
...
![使用 Python Slugify 对文件名 Slugify 化的 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/4guR1njZ/8c285673-f8b3-436c-abe7-b35c12b8d184.png)
...
![使用 Keyboard Maestro 对文件名 Slugify 化](https://p15.p3.n0.cdn.getcloudapp.com/items/xQuNn7DO/94b2673b-100e-4218-8c44-58c89a9e5b0e.gif)

### 标签管理

除了做好文件命名外，文件管理的另外一大策略就是对文件加上合适的标签，以便更好地分类、查找文件。Keyboard Maestro 自带了一组 action，可以实现对文件进行标签管理。

![为文件加上「重要」标签的 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/nOuQlPe2/87630b76-d96c-4fbb-9922-ac249a7e6b12.png)
...
![移除文件「重要」标签的 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/4guR1njE/5a04a108-128a-41ab-9ae1-54f4859b9913.png)
...
![使用 Keyboard Maestro 添加或移除文件标签](https://p15.p3.n0.cdn.getcloudapp.com/items/KouNZ4Bg/a29aed10-0f75-41f0-8a87-da79f9770f55.gif)
...
![在命令行中使用 `ls -a` 查看文件夹中的隐藏文件，其中就包括 `.DS_Store`](https://p15.p3.n0.cdn.getcloudapp.com/items/P8uDk9bj/121f0182-eaae-49c7-ba09-327570643b4e.png)
...
![BetterZip 可以设置排除 Mac 特定文件类型](https://p15.p3.n0.cdn.getcloudapp.com/items/p9uY8AGj/d1db92f2-8000-4a94-9ecd-19ab0895fb72.png)
...
![通过 Keyboard Maestro 压缩文件夹并排除 Mac 特定文件类型](https://p15.p3.n0.cdn.getcloudapp.com/items/GGuy6WRR/f4283328-7c46-4459-a40f-77aa79480c23.png)
...
![通过 Keyboard Maestro 压缩文件夹](https://p15.p3.n0.cdn.getcloudapp.com/items/bLuygkRq/f324eaf1-9e81-4e36-b3a3-abafd870df93.gif)

### 在 VS Code 中打开文件夹

对于很多代码项目来说，我们往往需要打开整个项目文件，而不只是双击打开单个文件。为了实现这个需求，我们可以在 Keyboard Maestro 中执行 AppleScript 来实现，如下图所示。

![在 VS Code 中打开当前所在文件夹的 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/wbu5967X/0479ae28-691a-488d-84ee-baef5ad5d816.png)
...
![在 VS Code 中打开当前所在文件夹](https://p15.p3.n0.cdn.getcloudapp.com/items/xQuNn7LO/d5a1c22d-8400-4327-87b2-a15ddc7364e2.gif)
...
![未登录 GitHub 账号的状态下，无法看到下载单个文件的按钮](https://p15.p3.n0.cdn.getcloudapp.com/items/yAun6rbz/00a75d8b-e485-4ece-a2b3-d681f77ca317.png)
...
![在 Safari 中下载 GitHub 仓库单个文件](https://p15.p3.n0.cdn.getcloudapp.com/items/2NuWEqyZ/8b763474-1055-4537-910b-1c819caf5b37.png)
...
![在 Safari 中使用 Keyboard Maestro 下载单个 GitHub 文件](https://p15.p3.n0.cdn.getcloudapp.com/items/qGuYX5Nk/637bc025-590f-4169-a9a6-d4af21530ddc.gif)
...
![更改为 `%FrontBrowserURL%` 实现在大多数浏览器中使用](https://p15.p3.n0.cdn.getcloudapp.com/items/DOuP2q9n/f9a50354-1806-49db-913f-d7a787872aba.png)

下图演示了在未登录 GitHub 账号的情况下，通过 [Arc 浏览器](https://arc.net/)下载 GitHub 仓库中的单个文件。

![在 Arc 浏览器下载 GitHub 仓库中的单个文件](https://p15.p3.n0.cdn.getcloudapp.com/items/v1unNY4Y/161b4e4a-7a6d-4cdf-b311-4bb76211ea33.gif)
...
![批量下载剪贴板中链接对应的文件](https://p15.p3.n0.cdn.getcloudapp.com/items/llu89N2w/cafdfe59-12f4-4e0b-8916-ac000f038a97.png)
...
![通过点击 Keyboard Maestro 菜单栏图标批量下载文件](https://p15.p3.n0.cdn.getcloudapp.com/items/9ZuL8dBj/66821bfa-b806-4fce-ab0d-ee4b8339a034.gif)
...
![Safari 中「下载后打开『安全』文件」的选项](https://p15.p3.n0.cdn.getcloudapp.com/items/RBuz4lWW/92f8a5f0-22d8-46a9-8604-8be4d2b67c22.png)
...
![自动打开下载文件夹中新添加的 PDF 文件](https://p15.p3.n0.cdn.getcloudapp.com/items/12uQo4r4/4861682f-c238-4d4e-b588-6be2b21acf5f.png)
...
![将下载文件夹中新添加的 PDF 移动到桌面的 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/bLuygkwq/8ba6af15-3e14-462f-90f9-fce9a7dcbd57.png)
...
![每周一自动导出 Mac 软件列表的 macro](https://p15.p3.n0.cdn.getcloudapp.com/items/Jrum1Dge/aa6e7dda-b4f0-43e0-a2d1-153cebd0f5ab.png)
...
![Cron Trigger](https://p15.p3.n0.cdn.getcloudapp.com/items/4guR1nJE/7b46c0a5-a1e7-473b-b25c-6e3184f9d9a1.png)
